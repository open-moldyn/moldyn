...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label = QtWidgets.QLabel(self.groupBox1d)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 1, 1, 1)
        self.lineComboW = QtWidgets.QComboBox(self.groupBox1d)
        self.lineComboW.setObjectName("lineComboW")
        self.gridLayout.addWidget(self.lineComboW, 0, 2, 1, 1)
        self.pushButton = QtWidgets.QPushButton(self.groupBox1d)
        ...
        self.formLayout_2 = QtWidgets.QFormLayout(self.groupBox1d_stat)
        self.formLayout_2.setObjectName("formLayout_2")
        self.PDFButton = QtWidgets.QToolButton(self.groupBox1d_stat)
        self.PDFButton.setObjectName("PDFButton")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.PDFButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "as a function of"))
