...
class Ui_CreateModel(object):
    def setupUi(self, CreateModel):
        ...
        self.groupBox_5 = QtWidgets.QGroupBox(self.wizardPage3)
        ...
        self.groupBox_7 = QtWidgets.QGroupBox(self.wizardPage3)
        ...
        self.groupBox_6 = QtWidgets.QGroupBox(self.wizardPage3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, CreateModel):
        ...
        self.wizardPage3.setTitle(_translate("CreateModel", "Other parameters"))
