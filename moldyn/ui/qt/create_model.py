...
class Ui_CreateModel(object):
    def setupUi(self, CreateModel):
        ...
        self.forcesPage = QtWidgets.QWizardPage()
        self.forcesPage.setObjectName("forcesPage")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.forcesPage)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.layout_forces = QtWidgets.QHBoxLayout()
        self.layout_forces.setObjectName("layout_forces")
        self.horizontalLayout_2.addLayout(self.layout_forces)
        CreateModel.addPage(self.forcesPage)
