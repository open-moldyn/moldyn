...
class Ui_species_params(object):
    def setupUi(self, species_params):
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.sigmaMLineEdit)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.sigmaMLabel)
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.epsilonJLineEdit)
        self.nameLineEdit = QtWidgets.QLineEdit(species_params)
        self.nameLineEdit.setObjectName("nameLineEdit")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.nameLineEdit)
        self.epsilonJLabel = QtWidgets.QLabel(species_params)
        self.epsilonJLabel.setObjectName("epsilonJLabel")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.epsilonJLabel)
        self.massKgLineEdit = QtWidgets.QLineEdit(species_params)
        self.massKgLineEdit.setObjectName("massKgLineEdit")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.massKgLineEdit)
        self.nameLabel.setBuddy(self.sigmaMLineEdit)
        self.sigmaMLabel.setBuddy(self.nameLineEdit)
        self.presetLabel.setBuddy(self.presetComboBox)
        self.massKgLabel.setBuddy(self.epsilonJLineEdit)
        self.epsilonJLabel.setBuddy(self.massKgLineEdit)

        self.retranslateUi(species_params)
        QtCore.QMetaObject.connectSlotsByName(species_params)
        species_params.setTabOrder(self.presetComboBox, self.sigmaMLineEdit)
        species_params.setTabOrder(self.sigmaMLineEdit, self.epsilonJLineEdit)
        species_params.setTabOrder(self.epsilonJLineEdit, self.nameLineEdit)
